...
class SurveyKit extends StatefulWidget {
  ...
  final Function(StepIdentifier, Set<QuestionResult<dynamic>> results) onChange;
...
class SurveyPage extends StatefulWidget {
  ...
  final Widget Function(AppBarConfiguration appBarConfiguration)? appBar;
  final Function(SurveyResult) onResult;
  final Function(StepIdentifier, Set<QuestionResult<dynamic>>) onChange;
    ...
    return BlocConsumer<SurveyPresenter, SurveyState>(
      ...
      listener: (context, state) async {
        ...
        if (state is PresentingSurveyState) {
          widget.onChange
              .call(state.currentStep.stepIdentifier, state.questionResults);
